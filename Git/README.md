/* ═══════════════════════════════════════════════════════════════
   ...
   • Masque totalement le widget Google Translate (logo inclus)
   • Persiste la langue choisie (cookie googtrans + localStorage)
   • Synchronise header ↔ drawer ↔ footer en temps réel
   • Géodétection auto + fallback multi-API
═══════════════════════════════════════════════════════════════ */
